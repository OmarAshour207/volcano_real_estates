            ...
            <div class="card card-form__body card-body">
                <form method="post" action="{{ route('states.update', $state->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="ar_name" name="ar_name" class="form-control" placeholder="{{ trans('admin.state') }} / {{ trans('admin.ar_name') }}..." value="{{ $state->ar_name }}">
                    </div>
                    <div class="form-group">
                        <label for="en_name"> {{ trans('admin.state') }} / {{ trans('admin.en_name') }}</label>
                        <input id="en_name" name="en_name" type="text" class="form-control" placeholder="{{ trans('admin.state') }} / {{ trans('admin.en_name') }}..." value="{{ $state->en_name }}">
                    </div>
